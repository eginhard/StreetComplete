...
class DownloadedTilesDao @Inject constructor(private val db: Database) {
    ...
    suspend fun put(tilesRect: TilesRect, typeName: String) {
    ...
    suspend fun remove(tile: TilePos): Int =
     ...
     *  given tile range
     */
    suspend fun get(tilesRect: TilesRect, ignoreOlderThan: Long): List<String> {
