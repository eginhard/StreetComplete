...
class NoteEditsDao @Inject constructor(
    ...
    suspend fun add(edit: NoteEdit): Boolean =
        db.transaction {
    ...
    suspend fun get(id: Long): NoteEdit? =
        db.queryOne(NAME, where = "$ID = $id") { it.toNoteEdit() }

    suspend fun getAll(): List<NoteEdit> =
    ...
    suspend fun markSynced(id: Long): Boolean =
    ...
    suspend fun updateNoteId(oldNoteId: Long, newNoteId: Long): Int =
    ...
    suspend fun markImagesActivated(id: Long): Boolean =
