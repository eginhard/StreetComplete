...
class ElementEditsDao @Inject constructor(
    ...
    suspend fun add(edit: ElementEdit) {
        val rowId = db.insert(NAME, edit.toPairs())
        edit.id = rowId
    }

    suspend fun get(id: Long): ElementEdit? =
    ...
    suspend fun getAll(): List<ElementEdit> =
    ...
    suspend fun updateElementId(elementType: Element.Type, oldElementId: Long, newElementId: Long): Int =
        db.update(
            NAME,
