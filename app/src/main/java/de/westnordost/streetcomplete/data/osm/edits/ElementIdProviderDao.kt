...
class ElementIdProviderDao @Inject constructor(private val db: Database) {
    ...
    suspend fun assign(editId: Long, nodeCount: Int, wayCount: Int, relationCount: Int) {
